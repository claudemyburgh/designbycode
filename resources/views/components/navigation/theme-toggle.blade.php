<headless-dropdown class="relative inline-block text-left z-10 ml-2 " placement="bottom bottom-start" offset="0 6" popper>
    ...
    <div
        ...
        class="hidden origin-top-right absolute w-40 rounded-md shadow-lg shadow-primary-500/50 border border-primary-500 bg-white dark:bg-gray-900 ring-1 ring-primary-500 ring-opacity-5 focus:outline-none"
        role="menu"
        tabindex="-1"
    >
        ...
        <div class="py-0" role="none">
            ...
            w-full"
                    ...
                    data-theme-name="light">
                                <span class="mr-4">
<svg aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-5">
  <path stroke-linecap="round" stroke-linejoin="round"
        d="M12 3v2.25m6.364.386l-1.591 1.591M21 12h-2.25m-.386 6.364l-1.591-1.591M12 18.75V21m-4.773-4.227l-1.591 1.591M5.25 12H3m4.227-4.773L5.636 5.636M15.75 12a3.75 3.75 0 11-7.5 0 3.75 3.75 0 017.5 0z"/>
            ...
            w-full"
                    ...
                    role="menuitem"
                    tabindex="-1"
                    data-theme-name="grayscale">
                                <span class="mr-4">
                                                          <svg xmlns="http://www.w3.org/2000/svg" aria-hidden="true" fill="none" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" class="size-5">
